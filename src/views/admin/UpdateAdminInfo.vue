      ...
      <div class="edit">
        <div class="avatar">
          <div class="img">
            ...
            <span v-t="'updateAdminInfo.update'"></span>
          </div>
        ...
        <div class="my-input">
          <label for="nickname" v-t="'updateAdminInfo.nicknameLabel'"></label>
          <input type="text" v-model="nickname" id="nickname">
        </div>
        <div class="my-input">
          <label for="intro" v-t="'updateAdminInfo.introLabel'"></label>
          <input type="text" v-model="intro" id="intro">
        </div>
        <button type="button" @click="edit" v-t="'updateAdminInfo.confirm'"></button>
      </div>
    </div>
  </div>
</template>
